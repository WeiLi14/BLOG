...
<head>
	<meta charset="UTF-8">
	<title>注册页面</title>
	<meta name="keywords" content="个人博客网">
	<meta name="content" content="个人博客网">
    ...
    <div class="zhuce_kong" id="dre_div">
    	<div class="zc">
            ...
            <h3>欢迎注册</h3>
                ...
                <div>
               		<input id="protocol" type="checkbox" onclick="checkProtocol();"><span>已阅读并同意<a href="#" target="_blank" ><span class="lan">《个人博客网用户协议》</span></a></span>
                    <br/>
...
<script type="text/javascript">
    ...
    //更换验证码,其中src对应的是servelt属性。点击更换图片，跳转到对应的servlet中，然后找到公共方法的servlet。
    ...
    $("#to_register").click (function(){
        if(!checkProtocol()){
            $("#protocol_span").text("请勾选\"阅读并接受个人博客网用户协议\"！").css("color","red");
        }else{
            $("#protocol_span").text("");
        }
